        ...
        <div className="contact-inner">
          <div className="fade-in">
            ...
            <div className="contact-info-list">
              <div className="contact-info-item"><strong>Location</strong> Adelaide, Melbourne &amp; online Australia-wide</div>
              <div className="contact-info-item"><strong>Email</strong> admin@titaniumtutoring.com</div>
              <div className="contact-info-item"><strong>Phone</strong> +61 456 753 747</div>
              <div className="contact-info-item"><strong>Response</strong> Within 24 hours</div>
            </div>
          </div>
