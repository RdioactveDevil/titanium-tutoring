    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .press-item{display:flex;align-items:center;gap:.5rem;font-weight:700;font-size:.9rem;color:#1a2540}
        .press-icon{width:24px;height:24px;background:#0a1628;border-radius:4px;display:flex;align-items:center;justify-content:center;font-size:.7rem;color:#c9a84c}
        ...
        @media(max-width:768px){
          ...
          .hero{padding-top:80px;padding-bottom:160px}
          .hero-stats{position:relative;bottom:auto;right:auto;margin-top:3rem;gap:1.5rem}
      ...
      <div className="press-banner">
        ...
        <div className="press-item"><div className="press-icon">📰</div>Herald Sun</div>
        <span className="press-label">Trusted by</span>
        <div className="press-item"><div className="press-icon">🎓</div>120+ Students · VCE · SACE · NAPLAN</div>
      </div>
